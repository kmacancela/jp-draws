  ...
  render(){
    return(
      <>
        ...
        <Cart getUser={this.props.getUser} cart={this.props.cart} user={this.props.user} loginAttempt={this.props.loginAttempt} fetchUser={this.props.fetchUser} totalAmount={this.props.totalAmount}/>
      </>
    )
  }
}
